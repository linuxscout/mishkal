...
class TashkeelClass:
    ...
    def tashkeel(self, inputtext, suggestion = False, format_display = 'text'):
        ...
        for text in texts:
            ...
            #~ for current_index, word_cases_list, current_synode  in zip(count(),detailled_syntax, synodelist):
            #~ print(izip(count(),detailled_syntax, synodelist))
            #~ print("1* List of synodes **********")
            #~ for syno in synodelist:
                #~ print(repr(syno))
            #~ print("1* / List of synodes **********")        
    ...
    def __choose_tashkeel(self, caselist, current_synode, previous_chosen_case = None,
     pre_node = None, next_node = None, previous_chosen_relation = False):
        ...
        #~ print(1, len(indxlist), indxlist, current_synode.chosen_indexes)
        #~ print(1, len(indxlist), indxlist, repr(current_synode))
        #~ return 0
